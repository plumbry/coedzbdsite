...
export default defineSchema({
  ...
  audienceInsightsCache: defineTable({
    ...
    eventsReady: v.optional(v.boolean()),
    lastUpdated: v.number(),
  }),
  ...
  audienceInsightsRebuildJobs: defineTable({
    ...
    /** @deprecated Legacy jobs stored all member IDs; new jobs use playersCursor. */
    memberIds: v.optional(v.array(v.id("players"))),
    totalCount: v.optional(v.number()),
    processedCount: v.number(),
    playersCursor: v.optional(v.union(v.string(), v.null())),
    male: v.optional(v.number()),
    female: v.optional(v.number()),
    genderUnknown: v.optional(v.number()),
    tierS: v.optional(v.number()),
    tierA: v.optional(v.number()),
    tierB: v.optional(v.number()),
    tierC: v.optional(v.number()),
    tierOther: v.optional(v.number()),
    tenureUnder3m: v.optional(v.number()),
    tenure3to6m: v.optional(v.number()),
    tenure6to12m: v.optional(v.number()),
    tenure1to2y: v.optional(v.number()),
    tenure2yPlus: v.optional(v.number()),
    tenureUnknown: v.optional(v.number()),
    eventsOverFive: v.optional(v.number()),
    eventsFiveOrLess: v.optional(v.number()),
    startedAt: v.number(),
