...
export default defineSchema({
  ...
  tierReEvaluationCache: defineTable({
     ...
     * Samples without strength still count toward trend (placement/kills).
     */
  ...
  bigSummerReEvalDashboardCache: defineTable({
    ...
    trackerStatus: v.string(),
    reEvalStatus: v.string(),
    assignedAdminId: v.optional(v.id("users")),
    assignedAdminName: v.optional(v.string()),
    ...
    notes: v.optional(v.string()),
    searchText: v.string(),
    isActiveAccepted: v.boolean(),
    lastUpdatedAt: v.number(),
    cachedAt: v.number(),
  })
    .index("by_re_eval", ["reEvalId"])
    .index("by_active_and_tier", ["isActiveAccepted", "currentTier"]),
