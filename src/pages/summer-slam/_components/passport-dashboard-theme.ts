...
export const ssPassportGrid =
  "flex flex-col gap-4 md:gap-6 lg:grid lg:min-h-0 lg:items-stretch lg:grid-cols-[minmax(0,1.25fr)_minmax(260px,0.75fr)] lg:gap-6 xl:grid-cols-[minmax(0,1.35fr)_minmax(280px,0.65fr)]";
export const ssPassportMainColumn = "order-2 min-w-0 lg:order-1 lg:flex lg:h-full lg:min-h-0 lg:flex-col";
export const ssPassportSidebar = "order-1 flex min-w-0 flex-col gap-4 lg:order-2 lg:h-full lg:min-h-0";
