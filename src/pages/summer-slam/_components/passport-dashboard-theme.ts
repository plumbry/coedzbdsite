...
export const ssPassportMainColumn = "order-1 min-w-0 lg:flex lg:h-full lg:min-h-0 lg:flex-col";
export const ssPassportSidebar = "order-2 flex min-w-0 flex-col gap-4 lg:h-full lg:min-h-0";
