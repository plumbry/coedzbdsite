  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex pt-14 lg:pt-0">
        ...
        <main className="flex-1 p-2 sm:p-6 space-y-8 overflow-auto">
        <div>
          <h1 className="text-2xl font-bold">Punishment Matrix</h1>
          <p className="text-muted-foreground mt-1">
            Offense progression tracks for event bans and disciplinary actions
          </p>
        </div>
